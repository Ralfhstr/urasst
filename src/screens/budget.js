        ...
        <SafeAreaView>
            <HStack ml={5} mt={5} justifyContent="flex-start" alignItems="center">
                ...
                <Box alignItems="center" flex={1} mr={10}>
                    <Heading color={'primary.700'}>Detail Balance</Heading>
                </Box>
            </HStack>
            <Center>
                <Box p={4} mt={5} w={80} h={210} rounded="2xl" overflow="hidden" borderColor="white" borderWidth="1" backgroundColor={'white'} shadow={1}>
                    <Stack space={3}>
                        ...
                        <HStack w={'85%'} justifyContent={'flex-end'} alignItems={'center'} >
                            <Box >
                                <Heading mr={2} size={'2xl'} color={"#155e75"}>$8,500</Heading>
                            </Box>
                            <TouchableOpacity onPress={() => setCreateCategoryModalOpen(true)}>
                                <Ionicons name="add-circle-outline" size={40} color="#0e7490" />
                            </TouchableOpacity>
                        </HStack>
                        <Progress value={80} />
            ...
            <HStack mt={6} ml={6} mr={6} justifyContent={'space-between'}>
                <Heading color={'primary.700'}>Spending Limit</Heading>
                <TouchableOpacity onPress={() => setCreateCategoryModalOpen(true)}>
